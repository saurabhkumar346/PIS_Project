                ...
                foreach($query_run as $row)
                {
                    ?>
                        ...
                        <form action="code.php" method="POST">
                            ...
                            <a href="cult_register.php" class="btn btn-danger"> CANCEL </a>
                            <button type="submit" name="cult_updatebtn" class="btn btn-primary"> Update </button>
